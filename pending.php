            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <li style="list-style: none; padding: 10px; "><a href="index.html" style="text-decoration: none; color: green;">Home</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="about.php" style="text-decoration: none; color: green;">About</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="suggestion.html" style="text-decoration: none; color: green;">Suggestion</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="contact_form.php" style="text-decoration: none; color: green;">Contact</a></li>
                </ul>
                  </div>
                </div>
                <div class="col-md-6">
