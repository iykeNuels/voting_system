    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <p style="padding-top: 20px;">4<sup>th</sup> Year Enroll</p>
                <form action="process_cand_4.php" method="post">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select name="txtbranch">
                          ...
                          <option>Deputy Class Representative </option>
                          <option>Treasurer</option>
                          <option>D.O.G</option>
                          <option>D.O.S</option>
                          <option>P.R.O 1</option>
                          <option>P.R.O 2</option>
                        </select></td>
                    </tr>
                    <tr>
